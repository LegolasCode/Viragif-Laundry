...
<body>
    ...
    <div class="container">
        ...
        <tr class="table-danger">
            ...
            while ($data = mysqli_fetch_array($hasil)) {
                ...
                <tbody>
                    <tr>
                        ...
                        <td>
                            <a href="update_layanan.php?id_layanan=<?php echo htmlspecialchars($data['id_layanan']); ?>"
                                class="btn btn-warning" role="button">Update</a>
                                <a href="<?php echo htmlspecialchars($_SERVER["PHP_SELF"]); ?>?id_layanan=<?php echo $data['id_layanan']; ?>"
            ...
            <a href="create_layanan.php" class="btn btn-primary" role="button">Tambah Data</a>
    </div>